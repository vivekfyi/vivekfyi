...
## Reading
* *Designing Data-Intensive Applications* by Martin Kleppmann (re-reading core chapters).
* *Crafting Interpreters* by Robert Nystrom (learning compiler architecture).

## Setup
* Operating from Bangalore, India.
* Embracing a high-focus environment with noise-canceling headphones, a mechanical keyboard, and a single screen setup.
